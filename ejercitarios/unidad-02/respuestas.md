...
| --- | --- | --- |
| Tiempo de respuesta de una aplicación móvil | | |
| Capacidad del equipo de estimar correctamente los plazos de entrega | | |
| Facilidad de uso de una interfaz | | |
| Documentación interna del código fuente | | |
...
| C. Robustez | ___ |
| D. Eficiencia | ___ |
| E. Mantenibilidad | ___ |
| F. Interoperabilidad | ___ |
...
| Red social de uso masivo | | |
| Sistema de trading financiero de alta frecuencia | | |
